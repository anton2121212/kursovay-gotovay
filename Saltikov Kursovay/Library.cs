...
namespace Saltikov_Kursovay
{
    class Library
    {
        public void Booklibrary()
        {
                ...
                string filePath = @"C:\Users\Kab-35-6\Desktop\Saltikov Kursovay\File.txt";
                ...
                try
                {
                    ...
                    switch (choice)
                    {
                        ...
                        case 0:
                            ...
                            return;
                        default: Console.WriteLine("Повторите попытку"); break;
                    }
                }
                catch (Exception ex) { Console.WriteLine(ex.Message); Console.WriteLine("Нажмите Enter"); Console.ReadLine();Console.Clear(); }
            }
